...
import 'package:music/components/identified_songinfo.dart';
                            ...
                            return Dismissible(
                              ...
                              confirmDismiss: (direction) {
                                return showDialog(
                                  ...
                                  builder: (context) => AlertDialog(
                                    title: Text(
                                      'Delete "${history[index]}" from history?',
                                      style: TextStyle(
                                        fontSize: Config.textSize(context, 3.5),
                                      ),
                                    ),
                              ...
                              child: ListTile(
                                ...
                                onTap: () async {
                                  ...
                                  await showModalBottomSheet(
                                    ...
                                    context: context,
                                    builder: (context) =>
                                        IdentifiedSong(history[index], song: null,),
                                  );
                                },
                                title: Text(
                                  history[index],
