...
import 'package:music/components/playlist_options.dart';
                          ...
                          ? ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return SongTile(
                                  ...
                                  allSongs: allSongs,
                                  songList: songList,
                                  playListName: widget.playListName as String,
              ...
              builder: (context, marker, child) {
                return Align(
                  ...
                  child: marker.isReadyToMark
                      ? PlaylistOptions(
                          widget.playListName as String, canDelete)
                ...
                onPressed: () async {
                  ...
                  if (canDelete) {
                    ...
                    await playlistDB.removeFromPlaylist(
                        widget.playListName as String, song);
